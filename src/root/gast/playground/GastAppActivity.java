...
import root.gast.playground.AndroidTools.AndroidTutorial;
import root.gast.playground.AndroidTools.AndroidWidgetActivity;
...
public class GastAppActivity extends Activity
{
    ...
    public void onLaunchAndroidWidgetClick(View view)
    {
    	startActivity(new Intent(this, AndroidWidgetActivity.class));
    }
    
    public void onLaunchAndroidTutorialClick(View view)
    {
    	startActivity(new Intent(this, AndroidTutorial.class));
    }
